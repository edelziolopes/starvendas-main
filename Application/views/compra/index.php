    ...
    <div class="flex justify-center">
        <div class="w-full">
            ...
            <div class="bg-card-bg shadow-xl rounded-xl">
                <div class="p-6">
                    <h2 class="text-2xl font-semibold text-text-purple mb-4 text-center">Cadastro de Compra</h2>
                    <form action="/compra/salvar" method="POST">
                        ...
                        <div class="flex flex-col md:flex-row items-start md:items-center mb-4 space-y-2 md:space-y-0">
                            <div class="flex-shrink-0 mr-4">
                                <label for="id_usuario" class="text-sm font-medium text-gray-700 flex items-center">
                                    <i class="fas fa-user mr-2"></i> Carrinho
                                </label>
                            </div>
                            <div class="flex-grow w-full">
                                <select class="w-full border border-gray-300 p-2 rounded-lg focus:ring-primary-purple focus:border-primary-purple transition duration-150" id="id_usuario" name="txt_carrinho" required>
                        ...
                        <div class="mb-4">
                            ...
                            <!-- Quantidade Input -->
                            <div class="flex flex-col md:flex-row items-start md:items-center mt-3 space-y-2 md:space-y-0">
                                <div class="flex-shrink-0 mr-4">
                                    <label for="preco" class="text-sm font-medium text-gray-700 flex items-center">
                                        <i class="fas fa-tag mr-2"></i> Preço
                                    </label>
                                </div>
                                <div class="flex-grow w-full">
                                    <input type="number" class="w-full border border-gray-300 p-2 rounded-lg focus:ring-primary-purple focus:border-primary-purple transition duration-150" id="preco" name="txt_preco" required>
                                </div>
                            </div>
                        </div>
                            <div class="flex flex-col md:flex-row items-start md:items-center mt-3 space-y-2 md:space-y-0">
                                <div class="flex-shrink-0 mr-4">
                                    <label for="categoria" class="text-sm font-medium text-gray-700 flex items-center">
                                        <i class="fas fa-tag mr-2"></i> Quantidade
                                    </label>
                                </div>
                                <div class="flex-grow w-full">
                                    <input type="number" class="w-full border border-gray-300 p-2 rounded-lg focus:ring-primary-purple focus:border-primary-purple transition duration-150" id="categoria" name="txt_quantidade" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end space-x-3 pt-4">
                            <a href="/carrinho" class="px-4 py-2 bg-gray-200 text-gray-700 font-medium rounded-lg shadow-sm hover:bg-gray-300 transition duration-150">Cancelar</a>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><i class="fas fa-user"></i> Carrinho</th>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><i class="fas fa-map-marker-alt"></i> Preço</th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><i class="fas fa-map-marker-alt"></i> Quantidade</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?= htmlspecialchars($dados['nome']) ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?= htmlspecialchars($dados['produto']) ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?= htmlspecialchars($dados['preco']) ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?= htmlspecialchars($dados['quantidade']) ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        ...
                                        <a href="/compra/excluir/<?= $dados['id'] ?>" class="text-red-600 hover:text-red-800 transition duration-150 mt-1 inline-flex items-center">
